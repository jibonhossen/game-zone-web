...
export const translations: Record<"bn" | "en", TranslationDict> = {
  bn: {
    ...
    hero: {
      ...
      subtitle: "Game Zone (GameZoneBD / GamesClubBD) অ্যাপের মাধ্যমে খেলুন আপনার প্রিয় গেমস এবং জিতে নিন আকর্ষণীয় সব প্রাইজ। নিরাপদ ও বিশ্বস্ত টুর্নামেন্ট প্ল্যাটফর্মে জয়েন করুন আজই।",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "Play your favorite games (Free Fire, PUBG, Ludo) and win exciting cash rewards on Game Zone (GameZoneBD / GamesClubBD). Join Bangladesh's safest, most trusted automated game tournament platform today.",
    ...
    downloadCTA: {
      ...
      subtitle: "Join thousands of players in Bangladesh. Install the Game Zone APK (GameZoneBD / GamesClubBD) and enter your first game tournament today!",
